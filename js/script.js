...
function sendEmail() {
    const bodyMessage = `Full Name: ${fullname.value}<br> Email: ${email.value}<br> Phone Number: ${phone.value}<br> Message: ${mes.value}`;
    Email.send({
        SecureToken:"d4ed892e-1e4d-4656-ac69-9620ed63ca82", 
        To: 'kunalhsarode@gmail.com',
        From: "kunalhsarode@gmail.com",
